...
export default function ExploreApiChalet() {
    const [Explore, setExplore] = useState([]);
    const [chosingLang , setchosingLang] = useState('en')
    const [chosingExploreKind , setchosingExploreKind] = useState('Chalets')
    ...
    const changeLanguage = (newLanguage) => {
      ...
      if(newLanguage === 'ar')
      {
        setchosingExploreKind('شاليهات')
      }else
      {
        setchosingExploreKind('Chalets')
      }
    };
