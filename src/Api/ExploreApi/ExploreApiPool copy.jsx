...
export default function ExploreApiConferences() {
    const [Explore, setExplore] = useState([]);
    const [chosingLang , setchosingLang] = useState('en')
    const [chosingExploreKind , setchosingExploreKind] = useState('Conferences')
    ...
    const changeLanguage = (newLanguage) => {
      ...
      if(newLanguage === 'ar')
      {
        setchosingExploreKind('مؤتمرات')
      }else
      {
        setchosingExploreKind('Conferences')
      }
    };
