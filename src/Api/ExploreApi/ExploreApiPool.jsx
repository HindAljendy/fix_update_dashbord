...
export default function ExploreApiPool() {
    const [Explore, setExplore] = useState([]);
    const [chosingLang , setchosingLang] = useState('en')
    const [chosingExploreKind , setchosingExploreKind] = useState('Pool')
    ...
    const changeLanguage = (newLanguage) => {
      ...
      if(newLanguage === 'ar')
      {
        setchosingExploreKind('المسابح')
      }else
      {
        setchosingExploreKind('Pool')
      }
    };
