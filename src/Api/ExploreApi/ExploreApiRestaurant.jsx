...
export default function ExploreApiRestaurant() {
    const [Explore, setExplore] = useState([]);
    const [chosingLang , setchosingLang] = useState('en')
    const [chosingExploreKind , setchosingExploreKind] = useState('Restaurant')
    ...
    const changeLanguage = (newLanguage) => {
      ...
      if(newLanguage === 'ar')
      {
        setchosingExploreKind('مطاعم')
      }else
      {
        setchosingExploreKind('Restaurant')
      }
    };
