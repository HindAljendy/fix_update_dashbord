...
export default function ExploreApiRersortEvents() {
    const [Explore, setExplore] = useState([]);
    const [chosingLang , setchosingLang] = useState('en')
    const [chosingExploreKind , setchosingExploreKind] = useState('RESORT EVENTS')
    ...
    const changeLanguage = (newLanguage) => {
      ...
      if(newLanguage === 'ar')
      {
        setchosingExploreKind('فعاليات المنتجع')
      }else
      {
        setchosingExploreKind('RESORT EVENTS')
      }
    };
