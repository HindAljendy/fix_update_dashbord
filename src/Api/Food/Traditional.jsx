...
export default function TraditionalAPI({start,end}) {

    const [WesternFood, setWesternFood] = useState([]);
    const [chosingLang, setchosingLang] = useState('en')
    const [chosingFoodKind, setchosingFoodKind] = useState('Traditional Food')
    ...
    const changeLanguage = (newLanguage) => {
        ...
        if (newLanguage === 'ar') {
            setchosingFoodKind('مأكولات تقليدية')
        } else {
            setchosingFoodKind('Traditional Food')
        }
    };
