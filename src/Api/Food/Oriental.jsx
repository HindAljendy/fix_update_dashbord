...
export default function OriantalAPI({start,end}) {

    const [WesternFood, setWesternFood] = useState([]);
    const [chosingLang, setchosingLang] = useState('en')
    const [chosingFoodKind, setchosingFoodKind] = useState('Oriental Food')
    ...
    const changeLanguage = (newLanguage) => {
        ...
        if (newLanguage === 'ar') {
            setchosingFoodKind('مأكولات شرقية')
        } else {
            setchosingFoodKind('Oriental Food')
        }
    };
